...
module.exports = async (req, res) => {
  try {
    ...
    const prototype = req.headers["x-forwarded-proto"] || "https";
    const u = new URL(req.url, `${prototype}://${host}`);
...
<head>
  ...
  <style>
    ...
    .bar { position: fixed; bottom: 0; left: 0; right: 0; display: flex; justify-content: space-around; padding: 12px; }
